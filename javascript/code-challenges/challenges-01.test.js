...
const addOne = (arr) => {
  // Solution code here...
  let resultArr = []; // use [2, 3, 4, 5, 6]

  arr.forEach(number => {
    let incrementedNum = number + 1;
    resultArr.push(incrementedNum);
  });
  return resultArr;

};
// forEach and push only work on arrays
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
------------------------------------------------------------------------------------------------ */
// arr = ['hi', 'how', 'are', 'you']
// resultsArr = ['hi!', 'how!', 'are!', 'you!']
const addExclamation = (arr) => {
  // Solution code here...
  let resultArr = []; // ['hi!', 'how!', 'are!', 'you!']
...
const allUpperCase = (arr) => {
  // Solution code here...
  let output = []; //['HI', 'HOW', 'ARE', 'YOU']

  arr.forEach(smallWord => {
    let bigWord = smallWord.toUpperCase();
    output.push(bigWord); //output(the word) has to be the same as line 55(in this case).
  });
  return output;
};
// function followed by parethesis
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
------------------------------------------------------------------------------------------------ */
// arr = ['hello', '301', 'students']
// output = ['HELLO!', '301!', 'STUDENTS!']
const greeting = (word) => {
  // Solution code here...
...
const createList = (availableItems) => {
  ...
  availableItems.forEach(item => {
    if (item.available) {
      traderJoesList.push(item.name);
    }
  });
  return traderJoesList;
};
